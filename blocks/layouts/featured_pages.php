...
if( have_rows('pages') ):
  ...
  echo '<div class="' . $bg . ' lighten-4 row block"><div class="container">';
  ...
  if($title) {
    ...
    // loop through the rows of data
      ...
      <h3 class="thin center upper"><a href="' . get_sub_field('feat_link') . '" rel="bookmark">' . get_sub_field('feat_title') . '</a></h3>
      </div>
      </div>';
